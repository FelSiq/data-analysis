...
LInicial <- 27.0 #L inicial da régua p/ medições de deformação com L variável, em cm
...
TabelaLVariavel <- data.frame(seq(from = LInicial, 
	to = 3.0, by = -LVariacao))
TabelaLVariavel[2] <- DeslocamentoReguaLVarPFixo
TabelaLVariavel[3] <- (TabelaLVariavel[[1]]^3)/100.0
